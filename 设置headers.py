...
<div class="breadcrumbs"><a title="返回首页" href="http://cuiqingcai.com"><i class="fa fa-home"></i></a> <small>></small> <a href="http://cuiqingcai.com/category/technique">技术杂谈</a> <small>></small> <a href="http://cuiqingcai.com/category/technique/python">Python</a> <small>></small> <span class="muted">Python爬虫入门四之Urllib库的高级用法</span></div>
			...
			<div class="meta">
				...
				<span class="muted"><i class="fa fa-eye"></i> 219190浏览</span>
...
<p>其中，agent就是请求的身份，如果没有写入请求身份，那么服务器不一定会响应，所以可以在headers中设置agent,例如下面的例子，这个例子只是说明了怎样设置的headers，小伙伴们看一下设置格式就好。</p><!-- Crayon Syntax Highlighter v_2.7.2_beta -->
		...
		<div id="crayon-5a0d001667aec206184257" class="crayon-syntax crayon-theme-github crayon-font-monaco crayon-os-pc print-yes notranslate" data-settings=" minimize scroll-mouseover wrap" style=" margin-top: 12px; margin-bottom: 12px; float: left; font-size: 12px !important; line-height: 15px !important;">
...
page = response.read() </textarea></div>
			<div class="crayon-main" style="">
				...
				<td class="crayon-nums " data-settings="show">
					<div class="crayon-nums-content" style="font-size: 12px !important; line-height: 15px !important;"><div class="crayon-num" data-line="crayon-5a0d001667aec206184257-1">1</div><div class="crayon-num crayon-striped-num" data-line="crayon-5a0d001667aec206184257-2">2</div><div class="crayon-num" data-line="crayon-5a0d001667aec206184257-3">3</div><div class="crayon-num crayon-striped-num" data-line="crayon-5a0d001667aec206184257-4">4</div><div class="crayon-num" data-line="crayon-5a0d001667aec206184257-5">5</div><div class="crayon-num crayon-striped-num" data-line="crayon-5a0d001667aec206184257-6">6</div><div class="crayon-num" data-line="crayon-5a0d001667aec206184257-7">7</div><div class="crayon-num crayon-striped-num" data-line="crayon-5a0d001667aec206184257-8">8</div><div class="crayon-num" data-line="crayon-5a0d001667aec206184257-9">9</div><div class="crayon-num crayon-striped-num" data-line="crayon-5a0d001667aec206184257-10">10</div><div class="crayon-num" data-line="crayon-5a0d001667aec206184257-11">11</div></div>
				</td>
						<td class="crayon-code"><div class="crayon-pre" style="font-size: 12px !important; line-height: 15px !important; -moz-tab-size:4; -o-tab-size:4; -webkit-tab-size:4; tab-size:4;"><div class="crayon-line" id="crayon-5a0d001667aec206184257-1"><span class="crayon-e">import </span><span class="crayon-e">urllib&nbsp;&nbsp;</span></div><div class="crayon-line crayon-striped-line" id="crayon-5a0d001667aec206184257-2"><span class="crayon-e">import </span><span class="crayon-e">urllib2&nbsp;&nbsp;</span></div><div class="crayon-line" id="crayon-5a0d001667aec206184257-3">&nbsp;</div><div class="crayon-line crayon-striped-line" id="crayon-5a0d001667aec206184257-4"><span class="crayon-v">url</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-s">'http://www.server.com/login'</span></div><div class="crayon-line" id="crayon-5a0d001667aec206184257-5"><span class="crayon-v">user_agent</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-s">'Mozilla/4.0 (compatible; MSIE 5.5; Windows NT)'</span><span class="crayon-h">&nbsp;&nbsp;</span></div><div class="crayon-line crayon-striped-line" id="crayon-5a0d001667aec206184257-6"><span class="crayon-v">values</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-sy">{</span><span class="crayon-s">'username'</span><span class="crayon-h"> </span><span class="crayon-o">:</span><span class="crayon-h"> </span><span class="crayon-s">'cqc'</span><span class="crayon-sy">,</span><span class="crayon-h">&nbsp;&nbsp;</span><span class="crayon-s">'password'</span><span class="crayon-h"> </span><span class="crayon-o">:</span><span class="crayon-h"> </span><span class="crayon-s">'XXXX'</span><span class="crayon-h"> </span><span class="crayon-sy">}</span><span class="crayon-h">&nbsp;&nbsp;</span></div><div class="crayon-line" id="crayon-5a0d001667aec206184257-7"><span class="crayon-v">headers</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-sy">{</span><span class="crayon-h"> </span><span class="crayon-s">'User-Agent'</span><span class="crayon-h"> </span><span class="crayon-o">:</span><span class="crayon-h"> </span><span class="crayon-v">user</span><span class="crayon-sy">_</span>agent<span class="crayon-h"> </span><span class="crayon-sy">}</span><span class="crayon-h">&nbsp;&nbsp;</span></div><div class="crayon-line crayon-striped-line" id="crayon-5a0d001667aec206184257-8"><span class="crayon-v">data</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-v">urllib</span><span class="crayon-sy">.</span><span class="crayon-e">urlencode</span><span class="crayon-sy">(</span><span class="crayon-v">values</span><span class="crayon-sy">)</span><span class="crayon-h">&nbsp;&nbsp;</span></div><div class="crayon-line" id="crayon-5a0d001667aec206184257-9"><span class="crayon-v">request</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-v">urllib2</span><span class="crayon-sy">.</span><span class="crayon-e">Request</span><span class="crayon-sy">(</span><span class="crayon-v">url</span><span class="crayon-sy">,</span><span class="crayon-h"> </span><span class="crayon-v">data</span><span class="crayon-sy">,</span><span class="crayon-h"> </span><span class="crayon-v">headers</span><span class="crayon-sy">)</span><span class="crayon-h">&nbsp;&nbsp;</span></div><div class="crayon-line crayon-striped-line" id="crayon-5a0d001667aec206184257-10"><span class="crayon-v">response</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-v">urllib2</span><span class="crayon-sy">.</span><span class="crayon-e">urlopen</span><span class="crayon-sy">(</span><span class="crayon-v">request</span><span class="crayon-sy">)</span><span class="crayon-h">&nbsp;&nbsp;</span></div><div class="crayon-line" id="crayon-5a0d001667aec206184257-11"><span class="crayon-v">page</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-v">response</span><span class="crayon-sy">.</span><span class="crayon-e">read</span><span class="crayon-sy">(</span><span class="crayon-sy">)</span><span class="crayon-h"> </span></div></div></td>
					</tr>
				</table>
			</div>
		</div>
...
<p>例如我们可以构建下面的headers</p><!-- Crayon Syntax Highlighter v_2.7.2_beta -->
		...
		<div id="crayon-5a0d001667af6903467226" class="crayon-syntax crayon-theme-github crayon-font-monaco crayon-os-pc print-yes notranslate" data-settings=" minimize scroll-mouseover wrap" style=" margin-top: 12px; margin-bottom: 12px; float: left; font-size: 12px !important; line-height: 15px !important;">
...
headers = { 'User-Agent' : 'Mozilla/4.0 (compatible; MSIE 5.5; Windows NT)'  ,
			...
			<div class="crayon-main" style="">
				<table class="crayon-table">
					<tr class="crayon-row">
				<td class="crayon-nums " data-settings="show">
					<div class="crayon-nums-content" style="font-size: 12px !important; line-height: 15px !important;"><div class="crayon-num" data-line="crayon-5a0d001667af6903467226-1">1</div><div class="crayon-num crayon-striped-num" data-line="crayon-5a0d001667af6903467226-2">2</div></div>
				</td>
						<td class="crayon-code"><div class="crayon-pre" style="font-size: 12px !important; line-height: 15px !important; -moz-tab-size:4; -o-tab-size:4; -webkit-tab-size:4; tab-size:4;"><div class="crayon-line" id="crayon-5a0d001667af6903467226-1"><span class="crayon-v">headers</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-sy">{</span><span class="crayon-h"> </span><span class="crayon-s">'User-Agent'</span><span class="crayon-h"> </span><span class="crayon-o">:</span><span class="crayon-h"> </span><span class="crayon-s">'Mozilla/4.0 (compatible; MSIE 5.5; Windows NT)'</span><span class="crayon-h">&nbsp;&nbsp;</span><span class="crayon-sy">,</span></div><div class="crayon-line crayon-striped-line" id="crayon-5a0d001667af6903467226-2"><span class="crayon-h">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="crayon-s">'Referer'</span><span class="crayon-o">:</span><span class="crayon-s">'http://www.zhihu.com/articles'</span><span class="crayon-h"> </span><span class="crayon-sy">}</span><span class="crayon-h">&nbsp;&nbsp;</span></div></div></td>
					</tr>
				</table>
			</div>
		</div>
...
<p>下面一段代码说明了代理的设置用法</p><!-- Crayon Syntax Highlighter v_2.7.2_beta -->
		...
		<div id="crayon-5a0d001667afa200193059" class="crayon-syntax crayon-theme-github crayon-font-monaco crayon-os-pc print-yes notranslate" data-settings=" minimize scroll-mouseover wrap" style=" margin-top: 12px; margin-bottom: 12px; float: left; font-size: 12px !important; line-height: 15px !important;">
...
urllib2.install_opener(opener)</textarea></div>
			<div class="crayon-main" style="">
				<table class="crayon-table">
					<tr class="crayon-row">
				<td class="crayon-nums " data-settings="show">
					<div class="crayon-nums-content" style="font-size: 12px !important; line-height: 15px !important;"><div class="crayon-num" data-line="crayon-5a0d001667afa200193059-1">1</div><div class="crayon-num crayon-striped-num" data-line="crayon-5a0d001667afa200193059-2">2</div><div class="crayon-num" data-line="crayon-5a0d001667afa200193059-3">3</div><div class="crayon-num crayon-striped-num" data-line="crayon-5a0d001667afa200193059-4">4</div><div class="crayon-num" data-line="crayon-5a0d001667afa200193059-5">5</div><div class="crayon-num crayon-striped-num" data-line="crayon-5a0d001667afa200193059-6">6</div><div class="crayon-num" data-line="crayon-5a0d001667afa200193059-7">7</div><div class="crayon-num crayon-striped-num" data-line="crayon-5a0d001667afa200193059-8">8</div><div class="crayon-num" data-line="crayon-5a0d001667afa200193059-9">9</div></div>
				</td>
						<td class="crayon-code"><div class="crayon-pre" style="font-size: 12px !important; line-height: 15px !important; -moz-tab-size:4; -o-tab-size:4; -webkit-tab-size:4; tab-size:4;"><div class="crayon-line" id="crayon-5a0d001667afa200193059-1"><span class="crayon-e">import </span><span class="crayon-e">urllib2</span></div><div class="crayon-line crayon-striped-line" id="crayon-5a0d001667afa200193059-2"><span class="crayon-v">enable_proxy</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-t">True</span></div><div class="crayon-line" id="crayon-5a0d001667afa200193059-3"><span class="crayon-v">proxy_handler</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-v">urllib2</span><span class="crayon-sy">.</span><span class="crayon-e">ProxyHandler</span><span class="crayon-sy">(</span><span class="crayon-sy">{</span><span class="crayon-s">"http"</span><span class="crayon-h"> </span><span class="crayon-o">:</span><span class="crayon-h"> </span><span class="crayon-s">'http://some-proxy.com:8080'</span><span class="crayon-sy">}</span><span class="crayon-sy">)</span></div><div class="crayon-line crayon-striped-line" id="crayon-5a0d001667afa200193059-4"><span class="crayon-v">null_proxy_handler</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-v">urllib2</span><span class="crayon-sy">.</span><span class="crayon-e">ProxyHandler</span><span class="crayon-sy">(</span><span class="crayon-sy">{</span><span class="crayon-sy">}</span><span class="crayon-sy">)</span></div><div class="crayon-line" id="crayon-5a0d001667afa200193059-5"><span class="crayon-st">if</span><span class="crayon-h"> </span><span class="crayon-v">enable_proxy</span><span class="crayon-o">:</span></div><div class="crayon-line crayon-striped-line" id="crayon-5a0d001667afa200193059-6"><span class="crayon-h">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="crayon-v">opener</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-v">urllib2</span><span class="crayon-sy">.</span><span class="crayon-e">build_opener</span><span class="crayon-sy">(</span><span class="crayon-v">proxy_handler</span><span class="crayon-sy">)</span></div><div class="crayon-line" id="crayon-5a0d001667afa200193059-7"><span class="crayon-st">else</span><span class="crayon-o">:</span></div><div class="crayon-line crayon-striped-line" id="crayon-5a0d001667afa200193059-8"><span class="crayon-h">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="crayon-v">opener</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-v">urllib2</span><span class="crayon-sy">.</span><span class="crayon-e">build_opener</span><span class="crayon-sy">(</span><span class="crayon-v">null_proxy_handler</span><span class="crayon-sy">)</span></div><div class="crayon-line" id="crayon-5a0d001667afa200193059-9"><span class="crayon-v">urllib2</span><span class="crayon-sy">.</span><span class="crayon-e">install_opener</span><span class="crayon-sy">(</span><span class="crayon-v">opener</span><span class="crayon-sy">)</span></div></div></td>
					</tr>
				</table>
			</div>
		</div>
...
<p>例如下面的代码,如果第二个参数data为空那么要特别指定是timeout是多少，写明形参，如果data已经传入，则不必声明。</p><!-- Crayon Syntax Highlighter v_2.7.2_beta -->
		...
		<div id="crayon-5a0d001667afe577160807" class="crayon-syntax crayon-theme-github crayon-font-monaco crayon-os-pc print-yes notranslate" data-settings=" minimize scroll-mouseover wrap" style=" margin-top: 12px; margin-bottom: 12px; float: left; font-size: 12px !important; line-height: 15px !important;">
...
response = urllib2.urlopen('http://www.baidu.com', timeout=10)</textarea></div>
			<div class="crayon-main" style="">
				<table class="crayon-table">
					<tr class="crayon-row">
				<td class="crayon-nums " data-settings="show">
					<div class="crayon-nums-content" style="font-size: 12px !important; line-height: 15px !important;"><div class="crayon-num" data-line="crayon-5a0d001667afe577160807-1">1</div><div class="crayon-num crayon-striped-num" data-line="crayon-5a0d001667afe577160807-2">2</div></div>
				</td>
						<td class="crayon-code"><div class="crayon-pre" style="font-size: 12px !important; line-height: 15px !important; -moz-tab-size:4; -o-tab-size:4; -webkit-tab-size:4; tab-size:4;"><div class="crayon-line" id="crayon-5a0d001667afe577160807-1"><span class="crayon-e">import </span><span class="crayon-e">urllib2</span></div><div class="crayon-line crayon-striped-line" id="crayon-5a0d001667afe577160807-2"><span class="crayon-v">response</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-v">urllib2</span><span class="crayon-sy">.</span><span class="crayon-e">urlopen</span><span class="crayon-sy">(</span><span class="crayon-s">'http://www.baidu.com'</span><span class="crayon-sy">,</span><span class="crayon-h"> </span><span class="crayon-v">timeout</span><span class="crayon-o">=</span><span class="crayon-cn">10</span><span class="crayon-sy">)</span></div></div></td>
					</tr>
				</table>
			</div>
		</div>
...
<p></p><!-- Crayon Syntax Highlighter v_2.7.2_beta -->
		...
		<div id="crayon-5a0d001667b01946124599" class="crayon-syntax crayon-theme-github crayon-font-monaco crayon-os-pc print-yes notranslate" data-settings=" minimize scroll-mouseover wrap" style=" margin-top: 12px; margin-bottom: 12px; float: left; font-size: 12px !important; line-height: 15px !important;">
...
response = urllib2.urlopen('http://www.baidu.com',data, 10)</textarea></div>
			<div class="crayon-main" style="">
				<table class="crayon-table">
					<tr class="crayon-row">
				<td class="crayon-nums " data-settings="show">
					<div class="crayon-nums-content" style="font-size: 12px !important; line-height: 15px !important;"><div class="crayon-num" data-line="crayon-5a0d001667b01946124599-1">1</div><div class="crayon-num crayon-striped-num" data-line="crayon-5a0d001667b01946124599-2">2</div></div>
				</td>
						<td class="crayon-code"><div class="crayon-pre" style="font-size: 12px !important; line-height: 15px !important; -moz-tab-size:4; -o-tab-size:4; -webkit-tab-size:4; tab-size:4;"><div class="crayon-line" id="crayon-5a0d001667b01946124599-1"><span class="crayon-e">import </span><span class="crayon-e">urllib2</span></div><div class="crayon-line crayon-striped-line" id="crayon-5a0d001667b01946124599-2"><span class="crayon-v">response</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-v">urllib2</span><span class="crayon-sy">.</span><span class="crayon-e">urlopen</span><span class="crayon-sy">(</span><span class="crayon-s">'http://www.baidu.com'</span><span class="crayon-sy">,</span><span class="crayon-v">data</span><span class="crayon-sy">,</span><span class="crayon-h"> </span><span class="crayon-cn">10</span><span class="crayon-sy">)</span></div></div></td>
					</tr>
				</table>
			</div>
		</div>
...
<p>如果要使用 HTTP PUT 和 DELETE ，只能使用比较低层的 httplib 库。虽然如此，我们还是能通过下面的方式，使 urllib2 能够发出 PUT 或DELETE 的请求，不过用的次数的确是少，在这里提一下。</p><!-- Crayon Syntax Highlighter v_2.7.2_beta -->
		...
		<div id="crayon-5a0d001667b05669428515" class="crayon-syntax crayon-theme-github crayon-font-monaco crayon-os-pc print-yes notranslate" data-settings=" minimize scroll-mouseover wrap" style=" margin-top: 12px; margin-bottom: 12px; float: left; font-size: 12px !important; line-height: 15px !important;">
...
response = urllib2.urlopen(request)</textarea></div>
			<div class="crayon-main" style="">
				<table class="crayon-table">
					<tr class="crayon-row">
				<td class="crayon-nums " data-settings="show">
					<div class="crayon-nums-content" style="font-size: 12px !important; line-height: 15px !important;"><div class="crayon-num" data-line="crayon-5a0d001667b05669428515-1">1</div><div class="crayon-num crayon-striped-num" data-line="crayon-5a0d001667b05669428515-2">2</div><div class="crayon-num" data-line="crayon-5a0d001667b05669428515-3">3</div><div class="crayon-num crayon-striped-num" data-line="crayon-5a0d001667b05669428515-4">4</div></div>
				</td>
						<td class="crayon-code"><div class="crayon-pre" style="font-size: 12px !important; line-height: 15px !important; -moz-tab-size:4; -o-tab-size:4; -webkit-tab-size:4; tab-size:4;"><div class="crayon-line" id="crayon-5a0d001667b05669428515-1"><span class="crayon-e">import </span><span class="crayon-e">urllib2</span></div><div class="crayon-line crayon-striped-line" id="crayon-5a0d001667b05669428515-2"><span class="crayon-v">request</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-v">urllib2</span><span class="crayon-sy">.</span><span class="crayon-e">Request</span><span class="crayon-sy">(</span><span class="crayon-v">uri</span><span class="crayon-sy">,</span><span class="crayon-h"> </span><span class="crayon-v">data</span><span class="crayon-o">=</span><span class="crayon-v">data</span><span class="crayon-sy">)</span></div><div class="crayon-line" id="crayon-5a0d001667b05669428515-3"><span class="crayon-v">request</span><span class="crayon-sy">.</span><span class="crayon-v">get_method</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-v">lambda</span><span class="crayon-o">:</span><span class="crayon-h"> </span><span class="crayon-s">'PUT'</span><span class="crayon-h"> </span><span class="crayon-p"># or 'DELETE'</span></div><div class="crayon-line crayon-striped-line" id="crayon-5a0d001667b05669428515-4"><span class="crayon-v">response</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-v">urllib2</span><span class="crayon-sy">.</span><span class="crayon-e">urlopen</span><span class="crayon-sy">(</span><span class="crayon-v">request</span><span class="crayon-sy">)</span></div></div></td>
					</tr>
				</table>
			</div>
		</div>
...
<p>可以通过下面的方法把 Debug Log 打开，这样收发包的内容就会在屏幕上打印出来，方便调试，这个也不太常用，仅提一下</p><!-- Crayon Syntax Highlighter v_2.7.2_beta -->
		...
		<div id="crayon-5a0d001667b08497236263" class="crayon-syntax crayon-theme-github crayon-font-monaco crayon-os-pc print-yes notranslate" data-settings=" minimize scroll-mouseover wrap" style=" margin-top: 12px; margin-bottom: 12px; float: left; font-size: 12px !important; line-height: 15px !important;">
...
response = urllib2.urlopen('http://www.baidu.com')</textarea></div>
			<div class="crayon-main" style="">
				<table class="crayon-table">
					<tr class="crayon-row">
				<td class="crayon-nums " data-settings="show">
					<div class="crayon-nums-content" style="font-size: 12px !important; line-height: 15px !important;"><div class="crayon-num" data-line="crayon-5a0d001667b08497236263-1">1</div><div class="crayon-num crayon-striped-num" data-line="crayon-5a0d001667b08497236263-2">2</div><div class="crayon-num" data-line="crayon-5a0d001667b08497236263-3">3</div><div class="crayon-num crayon-striped-num" data-line="crayon-5a0d001667b08497236263-4">4</div><div class="crayon-num" data-line="crayon-5a0d001667b08497236263-5">5</div><div class="crayon-num crayon-striped-num" data-line="crayon-5a0d001667b08497236263-6">6</div></div>
				</td>
						<td class="crayon-code"><div class="crayon-pre" style="font-size: 12px !important; line-height: 15px !important; -moz-tab-size:4; -o-tab-size:4; -webkit-tab-size:4; tab-size:4;"><div class="crayon-line" id="crayon-5a0d001667b08497236263-1"><span class="crayon-e">import </span><span class="crayon-e">urllib2</span></div><div class="crayon-line crayon-striped-line" id="crayon-5a0d001667b08497236263-2"><span class="crayon-v">httpHandler</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-v">urllib2</span><span class="crayon-sy">.</span><span class="crayon-e">HTTPHandler</span><span class="crayon-sy">(</span><span class="crayon-v">debuglevel</span><span class="crayon-o">=</span><span class="crayon-cn">1</span><span class="crayon-sy">)</span></div><div class="crayon-line" id="crayon-5a0d001667b08497236263-3"><span class="crayon-v">httpsHandler</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-v">urllib2</span><span class="crayon-sy">.</span><span class="crayon-e">HTTPSHandler</span><span class="crayon-sy">(</span><span class="crayon-v">debuglevel</span><span class="crayon-o">=</span><span class="crayon-cn">1</span><span class="crayon-sy">)</span></div><div class="crayon-line crayon-striped-line" id="crayon-5a0d001667b08497236263-4"><span class="crayon-v">opener</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-v">urllib2</span><span class="crayon-sy">.</span><span class="crayon-e">build_opener</span><span class="crayon-sy">(</span><span class="crayon-v">httpHandler</span><span class="crayon-sy">,</span><span class="crayon-h"> </span><span class="crayon-v">httpsHandler</span><span class="crayon-sy">)</span></div><div class="crayon-line" id="crayon-5a0d001667b08497236263-5"><span class="crayon-v">urllib2</span><span class="crayon-sy">.</span><span class="crayon-e">install_opener</span><span class="crayon-sy">(</span><span class="crayon-v">opener</span><span class="crayon-sy">)</span></div><div class="crayon-line crayon-striped-line" id="crayon-5a0d001667b08497236263-6"><span class="crayon-v">response</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-v">urllib2</span><span class="crayon-sy">.</span><span class="crayon-e">urlopen</span><span class="crayon-sy">(</span><span class="crayon-s">'http://www.baidu.com'</span><span class="crayon-sy">)</span></div></div></td>
					</tr>
				</table>
			</div>
		</div>
